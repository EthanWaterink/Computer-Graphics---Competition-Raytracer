...
Light Raytracer::parseLightNode (json const &node) const {
	...
	int cells_x = node["cells_x"];
	int cells_y = node["cells_y"];
	double width = node["width"];
	double height = node["height"];
	return Light (pos, col, cells_x, cells_y, width, height);
}
...
// =============================================================================
	...
	if (jsonscene.count ("ShadowType")) {
		ShadowType shadowType = jsonscene["ShadowType"];
